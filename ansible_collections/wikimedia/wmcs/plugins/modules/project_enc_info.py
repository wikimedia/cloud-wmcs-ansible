...
- name: Fetch hiera data for a specific openstack vm
  wikimedia.wmcs.project_enc_info:
...
def main():
    ...
    module.exit_json(changed=False, enc_data=data, prefix=None, openstack_project=openstack_project)
